...
namespace SwaySettings {
    ...
    public class Window : Hdy.ApplicationWindow {
        ...
        void add_settings () {
            ...
            list.append_val ("# GENERATED BY SwaySettings\n");
...
""");
            ...
            list.append_val (
                """
# Autostart
exec for file in $(ls ~/.config/autostart/); do gtk-launch $file &; done
""");
            Functions.write_settings (Strings.settings_folder_static_settings, list);
        }
    }
