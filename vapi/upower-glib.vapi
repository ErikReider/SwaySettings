...
namespace Up {
	...
	public class Device : GLib.Object {
		...
		[NoAccessorMethod]
		[Version (since = "1.90.10")]
		public string capacity_level { owned get; set; }
		[NoAccessorMethod]
		[Version (since = "1.0")]
		public int charge_cycles { get; set; }
		[NoAccessorMethod]
		[Version (since = "1.90.5")]
		public uint charge_end_threshold { get; set; }
		[NoAccessorMethod]
		[Version (since = "1.90.5")]
		public uint charge_start_threshold { get; set; }
		[NoAccessorMethod]
		[Version (since = "1.90.5")]
		public bool charge_threshold_enabled { get; set; }
		[NoAccessorMethod]
		[Version (since = "1.90.5")]
		public bool charge_threshold_supported { get; set; }
		[NoAccessorMethod]
		[Version (since = "0.9.0")]
		...
		[NoAccessorMethod]
		public double voltage_max_design { get; set; }
		[NoAccessorMethod]
